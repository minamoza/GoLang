...
type DishRep interface {
	Create(ctx context.Context, category *models.Dish) error
	All(ctx context.Context, filter *models.DishFilter) ([]*models.Dish, error)
	ByID(ctx context.Context, id int) (*models.Dish, error)
	Update(ctx context.Context, category *models.Dish) error
	Delete(ctx context.Context, id int) error
}